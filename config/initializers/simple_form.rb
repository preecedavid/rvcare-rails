...
SimpleForm.setup do |config|
  ...
  config.wrappers :batch_edit, tag: 'div', class: 'form-group', error_class: 'has-error' do |form_group|
    form_group.use :html5
    form_group.use :placeholder
    form_group.use :label

    form_group.wrapper tag: 'div', class: 'batch-edit-group' do |batch_edit_group|
      batch_edit_group.wrapper tag: 'div', class: 'row' do |row|
        row.wrapper tag: 'div', class: 'col-md-11 batch_edit_input' do |col|
          col.use :batch_input, class: 'form-control', disabled: true
        end
        row.wrapper tag: 'div', class: 'col-md-1' do |col|
          col.use :batch_update_enable_checkbox, class: 'enable-update'
        end
      end
    end
  end
  ...
  config.wrappers :batch_edit_multi_select, tag: 'div', class: 'form-group', error_class: 'has-error' do |form_group|
    form_group.use :html5
    form_group.optional :readonly
    form_group.use :label, class: 'control-label'
    form_group.wrapper tag: 'div', class: 'batch-edit-group' do |batch_edit_group|
      batch_edit_group.wrapper tag: 'div', class: 'row' do |row|
        row.wrapper tag: 'div', class: 'col-md-11 batch_edit_input' do |col|
          col.wrapper tag: 'div', class: 'form-inline' do |form_inline|
            form_inline.use :input, class: 'form-control', disabled: true
            form_inline.use :error, wrap_with: { tag: 'span', class: 'help-block' }
            form_inline.use :hint,  wrap_with: { tag: 'p', class: 'help-block' }
          end
        end
        row.wrapper tag: 'div', class: 'col-md-1' do |col|
          col.use :batch_update_enable_checkbox, class: 'enable-update'
  ...
  config.wrappers :batch_edit_inline_checkbox, tag: 'div', class: 'form-group', error_class: 'has-error' do |form_group|
    form_group.use :html5
    form_group.use :placeholder
    form_group.wrapper tag: 'div', class: 'batch-edit-group' do |batch_edit_group|
      batch_edit_group.wrapper tag: 'div', class: 'row' do |row|
        row.wrapper tag: 'div', class: 'col-xs-10 batch_edit_input' do |col|
          col.use :label_input, wrap_with: { class: 'checkbox' }, disabled: true
        end
        row.wrapper tag: 'div', class: 'col-xs-2 batch_edit_checkbox' do |col|
          col.use :batch_update_enable_checkbox, class: 'enable-update'
        end
      end
    end
